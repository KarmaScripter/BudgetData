CREATE VIEW IF NOT EXISTS "OpenCommitments" AS 
SELECT PurchaseId as OpenCommitmentId, BFY, (Select 8) as BudgetLevel, RpioCode, AhCode, FundCode, OrgCode, REPLACE(AccountCode, 'X', ' ') AS AccountCode, ProgramProjectCode, ProgramProjectName, OriginalActionDate, DocumentControlNumber, BocCode, BocName, FocCode, UPPER(FocName) as FocName, 
	CASE
	...
	END RcCode, SUM(OpenCommitments) as Amount
FROM Purchases
