CREATE VIEW IF NOT EXISTS "Expenditures" 
AS SELECT PurchaseId as ExpenditureId, BFY, (Select 8) as BudgetLevel, RpioCode, AhCode, FundCode, OrgCode, REPLACE(AccountCode, 'X', ' ') AS AccountCode, ProgramProjectCode, ProgramProjectName, OriginalActionDate, DocumentControlNumber, BocCode, BocName, FocCode, UPPER(FocName) as FocName, 
	CASE
	...
	END RcCode, SUM(Expenditures) as Amount
FROM Purchases
