CREATE VIEW IF NOT EXISTS "PurchaseActivity" 
AS SELECT RpioCode as RPIO, (SELECT '8') as BudgetLevel, BFY, FundCode, AhCode, OrgCode, REPLACE(AccountCode, 'X', ' ')	AS AccountCode, ProgramProjectCode, ProgramProjectName, NpmCode, DocumentControlNumber, PurchaseRequest, GrantNumber, 
	TransactionNumber, BocCode, BocName, FocCode, FocName, SiteProjectCode, OriginalActionDate,
	CASE
...
WHERE BudgetLevel = '8' AND 
	BocCode NOT IN ('10', '17')
GROUP BY RPIO, BFY, FundCode, AhCode, AccountCode, OrgCode, RcCode, BocCode, BudgetLevel;