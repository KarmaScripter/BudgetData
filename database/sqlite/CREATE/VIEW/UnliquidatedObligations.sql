CREATE VIEW IF NOT EXISTS "UnliquidatedObligations" 
AS SELECT PurchaseId as UnliquidatedObligationId, BFY, (Select 8) as BudgetLevel, RpioCode, AhCode, FundCode, OrgCode, REPLACE(AccountCode, 'X', ' ') AS AccountCode, ProgramProjectCode, ProgramProjectName, OriginalActionDate, DocumentControlNumber, BocCode, BocName, FocCode, UPPER(FocName) as FocName, 
	CASE
