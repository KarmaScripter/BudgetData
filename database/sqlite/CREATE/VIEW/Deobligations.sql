CREATE VIEW IF NOT EXISTS "Deobligations" 
AS SELECT PurchaseId as DeobligationId, BFY, (Select 8) as BudgetLevel, RpioCode, AhCode, FundCode, OrgCode, REPLACE(AccountCode, 'X', ' ') AS AccountCode, ProgramProjectCode, ProgramProjectName, OriginalActionDate, DocumentControlNumber, BocCode, BocName, FocCode, UPPER(FocName) as FocName, 
	CASE
	...
	END RcCode, SUM(Deobligations) as Amount
FROM Purchases
